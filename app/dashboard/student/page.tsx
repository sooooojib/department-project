...
export default async function StudentDashboard() {
    ...
    // Fetch student's attendance records for the selected courses
    ...
    // Map courseId to attendance metrics
    ...
    // Calculate global average attendance rate
    ...
    // Today's exams for the student's semester
    ...
    return (
        <div className="p-8 max-w-[1600px] mx-auto space-y-6">
            ...
            {/* Semester Request Selector Widget */}
            <SemesterSelector
                    ...
                    courses.length > 0 ? (
                        ...
                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 flex flex-col">
                            ...
                            <div className="text-center py-12 text-slate-400">
                                ...
                                <p className="text-xs text-slate-400 mt-1">No courses found matching Year {user.year} Semester {user.semester}.</p>
                            </div>
                        </div>
                    )
                ) : (
