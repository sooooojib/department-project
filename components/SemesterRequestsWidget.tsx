...
export default function SemesterRequestsWidget() {
    const { data, error: swrError, isLoading: loading, mutate: mutateRequests } = useSWR('/api/admin/semester-requests', fetcher);
    const requests: SemesterRequest[] = data?.requests || [];
